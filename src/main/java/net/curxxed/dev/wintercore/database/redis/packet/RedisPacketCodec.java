...
public final class RedisPacketCodec {
    ...
    private final Map<RedisPacketType, PacketDeserializer> deserializers = new HashMap<RedisPacketType, PacketDeserializer>();
    ...
    private void registerDefaults() {
        deserializers.put(RedisPacketType.RANK_TAG_SYNC, new PacketDeserializer() {
            @Override
            public RedisPacket<?> deserialize(JsonObject json) {
                return new RankTagSyncPacket(
                        json.get("sourceServer").getAsString(),
                        json.get("timestamp").getAsLong(),
                        RankTagSyncPacket.SyncType.valueOf(json.get("syncType").getAsString()),
                        json.get("yaml").getAsString()
                );
            }
        });

        deserializers.put(RedisPacketType.SERVER_SWITCH, new PacketDeserializer() {
            @Override
            public RedisPacket<?> deserialize(JsonObject json) {
                return new ServerSwitchPacket(
                        json.get("sourceServer").getAsString(),
                        json.get("timestamp").getAsLong(),
        ...
        deserializers.put(RedisPacketType.SERVER_STATUS, new PacketDeserializer() {
            @Override
            public RedisPacket<?> deserialize(JsonObject json) {
        ...
        deserializers.put(RedisPacketType.STAFF_ACTIVITY, new PacketDeserializer() {
            @Override
            public RedisPacket<?> deserialize(JsonObject json) {
                return new StaffActivityPacket(
                        json.get("sourceServer").getAsString(),
                        json.get("timestamp").getAsLong(),
        ...
        deserializers.put(RedisPacketType.REMOTE_COMMAND, new PacketDeserializer() {
            @Override
            public RedisPacket<?> deserialize(JsonObject json) {
                return new RemoteCommandPacket(
                        json.get("sourceServer").getAsString(),
                        json.get("timestamp").getAsLong(),
        ...
        deserializers.put(RedisPacketType.PLAYER_REPORT, new PacketDeserializer() {
            @Override
            public RedisPacket<?> deserialize(JsonObject json) {
                return new PlayerReportPacket(
                        json.get("sourceServer").getAsString(),
                        json.get("timestamp").getAsLong(),
        ...
        deserializers.put(RedisPacketType.DISGUISE_STATE, new PacketDeserializer() {
            @Override
            public RedisPacket<?> deserialize(JsonObject json) {
                return new DisguiseStatePacket(
                        json.get("sourceServer").getAsString(),
                        json.get("timestamp").getAsLong(),
                        UUID.fromString(json.get("uuid").getAsString()),
        ...
        deserializers.put(RedisPacketType.CONFIG_SYNC, new PacketDeserializer() {
            @Override
            public RedisPacket<?> deserialize(JsonObject json) {
